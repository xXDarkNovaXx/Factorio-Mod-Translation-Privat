	  ...
	  {
		{
		  ...
		  stripes =
		  {
			{ filename = "__aai-vehicles-hauler__/graphics/entity/hauler/hauler.png", width_in_frames = 8, height_in_frames = 8, },
		  }
		},
		{
		  width = 1384/8,
		  ...
		  {
			{ filename = "__aai-vehicles-hauler__/graphics/entity/hauler/hauler-mask.png", width_in_frames = 8, height_in_frames = 8, },
		  })
		},
		{
          width = 1592/8,
          ...
          {
            {
             filename = "__aai-vehicles-hauler__/graphics/entity/hauler/hauler-shadow.png",
             width_in_frames = 8,
             height_in_frames = 8,
            }
          }
